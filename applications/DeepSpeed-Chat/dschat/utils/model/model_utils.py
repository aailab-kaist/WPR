...
def create_hf_model(model_class,
    ...
    if "qwen" in model_name_or_path.lower():
        ...
        model.config.pad_token_id = model.config.pad_token_id if model.config.pad_token_id is not None else tokenizer.pad_token_id if tokenizer.pad_token_id is not None else tokenizer.eos_token_id
